...
from source.repositories.sqlalchemy.tasks.repositories.create.task_sqlalchemy_mapper import to_orm_task, to_task


class SqlalchemyCreateTaskRepository(CreateTaskRepository):
