...
from source.controllers.v1.schemas.entry_point_schema import (
    EntryPointLinksSchema, EntryPointSchema)
...
from source.controllers.v1.schemas.task_schema import (TaskLinksSchema,
                                                       TaskSchema,
                                                       TasksListSchema)
from source.controllers.v1.schemas.task_update_data_schema import \
    TaskUpdateDataSchema
from source.controllers.v1.schemas.token_schema import (TokenLinksSchema,
                                                        TokenSchema)
from source.controllers.v1.schemas.user_schema import (UserLinksSchema,
                                                       UserSchema)
